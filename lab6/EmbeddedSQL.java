...
public class EmbeddedSQL {
   ...
   public static void Query1(EmbeddedSQL esql){
      try{
         String query = "SELECT COUNT(P.pname) , S.sname FROM Suppliers S, Catalog C, Parts P WHERE C.sid = S.sid AND C.pid = P.pid GROUP BY S.sname";
         //System.out.print("\tEnter cost: $");
         //String input = in.readLine();
         //query += input;
   ...
   public static void Query2(EmbeddedSQL esql){
      try{
         String query = "SELECT COUNT(P.pname),S.sname FROM Suppliers S, Parts P, Catalog C WHERE C.sid = S.sid AND C.pid = P.pid GROUP BY S.sname HAVING COUNT(P.pname)>2";
         //System.out.print("\tEnter cost: $");
         //String input = in.readLine();
         //query += input;
   ...
   public static void Query3(EmbeddedSQL esql){
      try{
         String query = "SELECT COUNT(P.pname), S.sname FROM Suppliers S, Parts P, Catalog C WHERE C.sid = S.sid AND C.pid = P.pid AND P.color='Green'  GROUP BY S.sname";
         //System.out.print("\tEnter cost: $");
         //String input = in.readLine();
         //query += input;
   ...
   public static void Query4(EmbeddedSQL esql){
      try{
         String query = "SELECT MAX(C.cost),S.sname FROM Suppliers S, Parts P, Catalog C WHERE C.sid = S.sid AND C.pid = P.pid AND (P.color='Red' OR P.color='Green')  GROUP BY S.sname";
         //System.out.print("\tEnter cost: $");
         //String input = in.readLine();
         //query += input;
   ...
   public static void Query5(EmbeddedSQL esql){
      try{
         String query = "SELECT P.pname FROM Catalog C, Parts P WHERE C.pid = P.pid GROUP BY P.pname HAVING COUNT(P.pname) < ";
         System.out.print("\tEnter cost: $");
         String input = in.readLine();
         query += input;
   ...
   public static void Query6(EmbeddedSQL esql){
      try{
         String query = "SELECT S.address FROM Suppliers S, Catalog C, Parts P WHERE C.pid = P.pid AND S.sid = C.sid AND P.pname = '";
